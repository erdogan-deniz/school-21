...
[![codecov](https://codecov.io/gh/erdogan-deniz/school-21/branch/main/graph/badge.svg?flag=c-s21_math)](https://codecov.io/gh/erdogan-deniz/school-21?flags%5B0%5D=c-s21_math)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](../../LICENSE)

> *Own implementation of the C standard `math.h` library — packaged as a static library `s21_math.a` with full unit-test coverage against `libcheck`.*
...
> **TODO** — terminal capture of `./test` output is planned in the c/ Phase 2 demo slice.

## Documentation

- [Function-by-function overview](#overview-of-some-mathh-functions) below.
- API headers: [`src/s21_math.h`](src/s21_math.h).
...
- Pattern: each `s21_*` function is compared against its `<math.h>` reference
  for representative inputs.
- Required accuracy: 16 significant digits overall, 6 decimal places fractional.
