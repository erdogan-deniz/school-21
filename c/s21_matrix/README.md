...
[![codecov](https://codecov.io/gh/erdogan-deniz/school-21/branch/main/graph/badge.svg?flag=c-s21_matrix)](https://codecov.io/gh/erdogan-deniz/school-21?flags%5B0%5D=c-s21_matrix)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](../../LICENSE)

> *Own implementation of a numerical matrix library for C — addition, multiplication, transpose, determinant, algebraic complements and inverse, packaged as a static library `s21_matrix.a`.*
...
> **TODO** — terminal capture of representative determinant / inverse-matrix runs is planned in the c/ Phase 2 demo slice.

## Documentation

- [Matrix operations](#matrix-operations) section below.
- API headers: `src/s21_matrix.h`.
...
- Pattern: each `s21_*` matrix function verified against hand-computed cases for square,
  rectangular, identity, triangular, and degenerate matrices.
- Required coverage: ≥ 80 % per function (gcov-checked).
- Verifiable accuracy: 7 decimal places in element comparison.
