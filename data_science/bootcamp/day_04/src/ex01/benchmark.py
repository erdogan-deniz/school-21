...
def print_fastest_func_worktime() -> None:
    ...
    map_approach_time: float = timeit.timeit(lambda: get_gmails_map(emails), number=90000000)

    max_approach_time: float = max(cycle_approach_time, list_compr_approach_time, map_approach_time)
    min_approach_time: float = min(cycle_approach_time, list_compr_approach_time, map_approach_time)
    sum_approaches_time: float = cycle_approach_time + list_compr_approach_time + map_approach_time
