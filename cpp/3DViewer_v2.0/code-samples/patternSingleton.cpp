...
/* Now you can create somewhere an instance, calling getInstance() the first
   time. This will lead to static instance being determined and then static
