...
[![codecov](https://codecov.io/gh/erdogan-deniz/school-21/branch/main/graph/badge.svg?flag=c-s21_decimal)](https://codecov.io/gh/erdogan-deniz/school-21?flags%5B0%5D=c-s21_decimal)
...
> **TODO** — terminal capture of arithmetic-overflow / bank-rounding examples is planned in the c/ Phase 2 demo slice.

## Documentation

- [Binary representation](#binary-representation) and [arithmetic operators](#arithmetic-operators) sections below.
- API headers: `src/s21_decimal.h`.
...
- Pattern: `s21_*` arithmetic / comparison / conversion functions verified against
  representative inputs across the entire `±79,228,162,514,264,337,593,543,950,335` range.
