...
Window_One ::Window_One(QWidget* parent)
    : QWidget(parent), ui(new Ui ::Window_One) {
  ui->setupUi(this);
...
Window_One ::~Window_One() { delete ui; }
...
void Window_One ::draw_graph(char* formula, double xBegin, double xEnd,
                             double yBegin, double yEnd, long double* X,
                             Ui ::Window_One* ui) {
  double h = 0.1;
