...
answers = {
    "first": ["  Not bad.", "  Delightfully!", "  Let's not ask stupid questions..."],
    "second": ["  No.", "  Why would I...", "  Aha, of course.... no."],
    "third": ["  I don't know.", "  How did I end up in the desert?", "  How am I not helping?"],
    "fourth": [
    ...
    "sixth": ["  Yes.", "  I'm not sure...", "  The hell with it! Life is unfair."],
    "seventh": [
    ...
    "ninth": ["  I do not remember.", "  Probably, yes.", "  What? Oh, yes, of course..."],
    "tenth": ["  Yes.", "  It's hard to say...", "  ...Kha, most likely."],
}
