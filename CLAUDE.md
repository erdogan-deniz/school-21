...
- **Tracking mechanism:**
  ...
  - **Per-subproject detail:** `docs/plans/<track>/<subproject>.md` (38 files). Each plan has an "At a glance" header, the eight-item DoD checklist with `[x]` / `[~]` / `[ ]` ticks, subproject-specific tasks, and a chronological History log linked to commits. Template: `docs/plans/_TEMPLATE.md`.
