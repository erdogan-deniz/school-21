...
- **README structure rule:** every subproject README has a *production fold* on top (badges → tagline → Quick start → Demo → Documentation → License/attribution → `---`) followed by the *original School 21 task description* preserved verbatim. No existing School 21 narrative content (preamble, Chapter I/II/III, story sections) may be removed.
